...
- **Role gate**: DB explorer and console-settings also require `X-Console-Role: admin`. Destructive CLI commands (`cleanup`, `backup`, `setup`, `seed-demo`, `test`, `purge-data`) are blocked in User module.
